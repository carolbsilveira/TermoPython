...
Tx =[]
Py=[]
# Defiene um operador para analisar a resposta dada.
valido = 0

print('Bem vindo ao TermoPython.\n\n --> Esse software foi feito para otimizar valores experimentais de pressão em sistemas de equilírios de fase líquido - vapor.\n --> Para consultar detalhes de uso do software acesse o tutorial e para detalhes de funcionamento acesse o manual.')
...
# pede ao usuário que escolha uma das aplicações do software e, de acordo com a opção escolhida, exibe o próximo input.
    ...
    if algoritmo == 'substância pura' or algoritmo =='sp':
        ...
        while marcador == 0:
            escolha = input('\nO software será usado para o cálculo um único ponto de pressão, ou de uma curva de equilíbrio(-ponto/p- ou -curva/c-): \n')
